...
const HINT_NOTES = [
    "Pindutin mo yung heart sa baba",
    "Sagutan mo yung quiz para makuha yung password",
    "Yun lang 😛"
];
...
function openJar() {
    ...
    if (display) {
        display.innerText = HINT_NOTES[currentNoteIndex];
        ...
        if (currentNoteIndex < HINT_NOTES.length - 1) {
            currentNoteIndex++;
        } else {
            // currentNoteIndex = 0; 
        }
